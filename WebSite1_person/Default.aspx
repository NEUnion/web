...
<body>
    ...
    <table class="style1">
        <caption>
            请输入个人详细信息<table class="style1">
                <tr>
                    <td class="style4">
                        &nbsp;</td>
                    <td>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/page2.aspx">填写说明</asp:HyperLink>
                    </td>
                </tr>
            </table>
        </caption>
        ...
        <tr>
            ...
            <td class="style3">
                ...
                <asp:ListItem Value="C编程" >C编程</asp:ListItem>
                </asp:ListBox>
        ...
        <tr>
            ...
            <td class="style3">
                ...
                <br />
                <asp:Image ID="show_Image" runat="server" Width="146px" />
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="style3">
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="庐山.jpg"  
        ...
        <tr>
            ...
            <td class="style3">
                ...
                <input id="Reset1" type="reset" value="重置" /><asp:Button ID="Button4" runat="server" Text="提交" onclick="Button4_Click" />
